<template>
  <div>
    <button class=" bg-gray-200 text-blue-600 px-2 py-2 rounded-md mr-2" type="button" style="transition: all .15s ease" v-on:click="toggleModal()">
      {{buttonText}}
    </button>
            ...
            <div class="divide-y divide-gray-200">
              <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                <div class="flex flex-col">
                  ...
                  <input v-model="adToUpdate.title" type="text" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                </div>
                <div class="flex flex-col">
