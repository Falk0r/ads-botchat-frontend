<template>
    <!-- component -->
    <nav id="header" class="fixed w-full z-30 top-0 py-1 bg-white shadow-lg border-b border-blue-400">
        <div class="w-full flex items-center justify-between mt-0 px-6 py-2">
            ...
            <div class="order-2 md:order-3 flex flex-wrap items-center justify-end mr-0 md:mr-4" id="nav-content">
                ...
                <div class="auth flex items-center w-full md:w-full" v-else>
                    <NuxtLink to="/login"><button class="bg-transparent text-gray-800  p-2 rounded border border-gray-300 mr-4 hover:bg-gray-100 hover:text-gray-700">Sign in</button></NuxtLink>
                    <NuxtLink to="/register"><button class="bg-blue-600 text-gray-200  p-2 rounded  hover:bg-blue-500 hover:text-gray-100">Sign up</button></NuxtLink>
                </div>
            </div>
        </div>
   </nav>
